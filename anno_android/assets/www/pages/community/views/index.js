define([
    ...
    function (arrayUtil, dom, domClass, domGeom, domStyle, query, lang, connect, win, has, sniff, registry, at, domAttr, TransitionEvent, Memory, getStateful, CsvStore, eventModel)
    {
